...
function Moxie:KeySystem()
    ...
    submitBtn.MouseButton1Click:Connect(function()
        ...
        if valid then
            writefile(Config.KeyFile, entered)
...
function Moxie:LoadingScreen()
    ...
    ring2Img.ImageTransparency = 0.5
    ring2Img.Parent = ring2

    local ring3 = Instance.new("Frame")
    ring3.Size = UDim2.new(0,250,0,250)
    ring3.Position = UDim2.new(0.5,-125,0.5,-165)
    ...
    subLabel.Position = UDim2.new(0.5,-200,0.5,80)
    ...
    barGlow.Color = ColorSequence.new{ColorSequenceKeypoint.new(0,ActiveTheme.Accent),ColorSequenceKeypoint.new(1,Color3.new(1,1,1))}
    ...
    local conn = RunService.RenderStepped:Connect(function(dt)
        ring1.Rotation += 60 * dt
        ring2.Rotation -= 40 * dt
        ring3.Rotation += 25 * dt
        logo.Rotation += 10 * dt
    ...
    task.spawn(function()
        ...
        local steps = {
            ...
            {text = "Building Interface...", p = 0.8},
            {text = "Almost Ready...", p = 0.95},
            {text = "Done!", p = 1.0},
        }
        ...
        for _, obj in ipairs({nameLabel, subLabel, statusLabel, logoText}) do
            TweenService:Create(obj, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {TextTransparency = 1}):Play()
        end
        for _, obj in ipairs({ring1Img, ring2Img, ring3Img}) do
            TweenService:Create(obj, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()
        end
...
function Moxie:CreateWindow(title)
    ...
    function Window:CreateTab(name, icon)
        ...
        local function Register(name2, inst)
            table.insert(Window.AllElements, {Name = name2, Instance = inst})
        end
        ...
        function Tab:CreateToggle(text, default, callback)
            ...
            toggle.MouseButton1Click:Connect(function()
                ...
                Tween(dot, "Position", state and UDim2.new(1,-23,0.5,-10) or UDim2.new(0,3,0.5,-10), 0.25)
                callback(state)
            end)
        ...
        function Tab:CreateSlider(text, min, max, default, callback)
            ...
            local function update(pos)
                ...
                Tween(sdot, "Position", UDim2.new(size,-7,0.5,-7), 0.05)
                callback(value)
            end
            ...
            return {
                Set = function(_, v)
                    ...
                    Tween(sdot, "Position", UDim2.new(size,-7,0.5,-7), 0.2)
                    callback(value)
                end,
        ...
        function Tab:CreateColorPicker(text, default, callback)
            ...
            hexBox.Size = UDim2.new(1,-20,0,24)
            hexBox.Position = UDim2.new(0,10,0,80)
            hexBox.BackgroundColor3 = ActiveTheme.Secondary
            hexBox.Text = ""
            hexBox.PlaceholderText = "#RRGGBB"
            hexBox.TextColor3 = ActiveTheme.Text
            hexBox.PlaceholderColor3 = ActiveTheme.DarkText
